...
class ADB(object):
    ...
    # def new_window(self,content):
    #     cmd = ['adb', '-s', self.device, 'shell', ' am start -n com.UCMobile/.main.UCMobile -e load new -d %s' %content]
    #     return self._exec(cmd)
    #
    # def cur_window(self,content):
    #     cmd = ['adb', '-s', self.device, 'shell', ' am start -n com.UCMobile/.main.UCMobile -e load fg -d %s' %content]
    #     return self._exec(cmd)
    #
    # def more_window(self):
    #     cmd = ['adb', '-s', self.device, 'shell', ' am start -n com.UCMobile/.main.UCMobile -e click window ']
    #     return self._exec(cmd)
    #
    # def tap_back(self):
    #     cmd = ['adb', '-s', self.device, 'shell', 'am start -n com.UCMobile/.main.UCMobile -e click back']
    #     return self._exec(cmd)
    #
    # def tap_home(self):
    #     cmd = ['adb', '-s', self.device, 'shell', 'am start -n com.UCMobile/.main.UCMobile -e click home']
    #     return self._exec(cmd)
    #
    # def refresh_page(self):
    #     cmd = ['adb', '-s', self.device, 'shell', 'am start -n com.UCMobile/.main.UCMobile -e click refresh']
    #     return self._exec(cmd)
    ...
    def drag(self, start, end, duration, **kwargs):
        args = start + end + (duration * 100,)
        args = [str(x) for x in args]
        return self._adb_shell("input", "swipe", *args)

    def drag_up(self):
        #return self.drag((895, 1842), (895, 551), 1)
        return self.drag((359, 764), (359, 96), 1)  #华为荣耀4
        # return self.drag((361, 819), (361, 179), 1)

    def drag_down(self):
        return self.drag((456, 201), (458, 775),1)

    def drag_left(self):
        return self.drag((655, 698),(188, 698),1)

    def drag_right(self):
        return self.drag((188, 698),(655, 698),1)

    def long_press(self, dx, dy):
        return self.drag((dx, dy), (dx, dy), 2)
